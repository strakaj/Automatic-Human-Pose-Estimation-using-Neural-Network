...
def main(args):
    ...
    input_params = ['lr', 'lr_backbone', 'batch_size', 'epochs', 'lr_drop', 'batch_size', 'transformations',
                    'augmentations', 'sgd', 'scheduler', 'enc_layers', 'dec_layers', 'nheads', 'time', 'backbone',
                    'crop_w']
